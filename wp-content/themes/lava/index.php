        ...
        <div class="container text-center">
            <div class="row">
                ...
                <div class="col-md-5 col-sm-12 h-25">
                    <img src="assets\images\header-galaxy-image.jpg" alt="No image yet!">
                </div>
            </div>
        </div>
    </header>
    <main>
        <section class="section-1 container-fluid">
            <container class="text-center">
                <div class="row">
                    <div class="col-md-6">
                        <img class="section-1-img" src="assets\images\landscape1.jpg" alt="section 1 image 1">
                    ...
                    <div class="col-md-6">
                        <img class="section-1-img" src="assets\images\landscape2.jpg" alt="section 1 image 2">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-img-top">
                                <img src="assets/images/face1.jpg" class="img-fluid" alt="card-image">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-img-top">
                                <img src="assets/face2.jpg" class="img-fluid" alt="card-image">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-img-top">
                                <img src="assets/images/face3.jpg" class="img-fluid" alt="card-image">
                            </div>
                        </div>
                    </div>
                </div>
